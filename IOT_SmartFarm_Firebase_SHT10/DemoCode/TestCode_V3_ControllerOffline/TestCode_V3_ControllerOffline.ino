...
void debug() {
  ...
  Serial.println("Nhiệt độ= " + String(rdTemp) + "--Cài đặt nhiệt độ= " + tmpstateTemp
                 + "--Dộ ẩm= " + String(rdHumi) + "--Cài đặt độ ẩm= " + tmpstateHumi);
  yield();
}
void getValue() {
...
void StabilityTempHumi() {
  ...
  */
  ...
  if (rdTemp >= tmpstateTemp && rdTemp > 0 && statusTemp == 0) {
    /*
    ...
    */
    ...
    statusTemp = 1;
  } else if (rdTemp <= (tmpstateTemp - DifTemp) && rdTemp && statusTemp == 1) {
    /*
  ...
  /*
     ...
     Ví dụ 75 >= 75 --> OFF
  */
  if (rdHumi <= tmpstateHumi && rdHumi > 0 && statusHumi == 0) {
    /*
    ...
    */
    ...
    statusHumi = 1;
  } else if (rdHumi >= (tmpstateHumi + DifHumi) && rdHumi > 0 && statusHumi == 1 ) {
    /*
...
void handingeventbtn(String path, String data) {
  ...
  */
  ...
  else if (path == "/Button/Btn3")
  {
    ...
    DifTemp = value;
  } else if (path == "/Sensor/Temp") {
    rdTemp = value;
  } else if (path == "/Sensor/Humi") {
    rdHumi = value;
  }
}
